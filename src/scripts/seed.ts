...
async function seedSettings(): Promise<void> {
  const settings = [
    ...
    },
    {
      ...
      isPublic: true,
      isEditable: true,
      description: 'Admin console display name',
    },
    {
      key: 'base.adminLogoUrl',
      value: '',
      group: 'base',
      type: 'url',
      isPublic: true,
      isEditable: true,
      description: 'Admin console logo URL',
    },
    {
      key: 'base.loginBackgroundUrl',
      value: '',
      group: 'base',
      type: 'url',
      isPublic: true,
    ...
    {
      key: 'base.homeBackgroundUrl',
      value: '',
      group: 'base',
      type: 'url',
      isPublic: true,
      isEditable: true,
      description: 'Home page background image URL',
    },
    {
      key: 'base.faviconUrl',
      value: '',
    ...
    {
      key: 'base.projectDescription',
      value: 'Reusable management backend scaffold',
      group: 'base',
      type: 'string',
      isPublic: true,
      isEditable: true,
      description: 'Project description shown in admin UI',
    },
    {
      key: 'base.copyright',
      value: '',
      ...
      isPublic: true,
      isEditable: true,
      description: 'Copyright text shown in public/admin UI',
    },
    {
      key: 'base.supportUrl',
      value: '',
